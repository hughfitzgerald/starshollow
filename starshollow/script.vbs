...
'    \  /  | |      \  /\  /    | |____ >  < (_| | | | | | | |_) | |  __/    | | (_| | |_) | |  __/
'     \/   |_|       \/  \/     |______/_/\_\__,_|_| |_| |_| .__/|_|\___|    |_|\__,_|_.__/|_|\___|   V1.7
'                                                          | |
'                                                          |_|
'
'
...
'1.6.2 apophis - Set DTMass and STMass to 0.1.
'1.6.3 apophis - Updated slingshot correction curves
'1.6.4 apophis - Added Gottlieb flippers (thanks BorgDog). Fixed default EOSReturn setting. Converted some Fleep sounds to mono.
'1.7 Release
...
' Modes:
' * Luke Danes' Diner Danceoff
' * Jess & Dean: To the Death
' * Logan Sucks
' * Babette Can't Take a Hint
' * Get a Job (Starring Kirk)
' * Hooking Up at Miss Patty's
' * Lorelai's Breakup Breakaway
' * Paris & Rory: Enemies to Friends to Lovers
...
Set ST16 = (new StandupTarget)(sw16, psw16,16, 0)
...
Sub l41animate: p41.BlendDisableLighting = 200 * (l41.GetInPlayIntensity / l41.Intensity): End Sub
