...
Sub CreateBaseMode()
    ...
    With CreateGlfMode("base", 110)
        ...
        With .EventPlayer()
            ...
            .Add "timer_base_music_complete{modes.eob_bonus.active == False and modes.dance_marathon.active == False and modes.town_meeting.active == False and modes.dinner.active == False}", Array("base_music_stop","start_new_song")
