...
Set DT7 = (new DropTarget)(s_DT7, aDT7, pDT7, 7, 0, False)
Set DT8 = (new DropTarget)(s_DT8, aDT8, pDT8, 8, 0, False)
...
Sub DT7Callback(state)
    Select Case state
        Case 0
            DTRaise 7
            SoundDropTargetDrop pDT7
        Case 1
            DTDrop 7
        Case 3
            DTEnableKeepup 7
...
Sub DT8Callback(state)
    Select Case state
        Case 0
            DTRaise 8
            SoundDropTargetDrop pDT8
        Case 1
            DTDrop 8
        Case 3
            DTEnableKeepup 8
